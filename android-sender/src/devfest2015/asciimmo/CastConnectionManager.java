...
public class CastConnectionManager extends Observable {
    ...
    /**
     * Interface used to provide the Google Cast application ID for this application.
     */
    ...
    public CastConnectionManager(Context context, CastAppIdProvider appIdProvider) {
        mContext = context;
        mAppIdProvider = appIdProvider;
